            ...
            {navItems.map((item) => {
              ...
              return (
                <Link
                  ...
                  className={`flex items-center gap-4 rounded-lg px-4 py-3 text-sm font-medium transition duration-200 ${
                    isActive
              ...
              return (
                <Link
                  ...
                  className={`flex items-center gap-3 rounded-lg px-3.5 py-2.5 transition-all duration-200 border ${
                    isActive
                      ? "bg-amber-500/10 text-amber-500 border-amber-500/25 shadow-sm shadow-amber-950/20"
                      : "text-zinc-400 hover:bg-zinc-800/40 hover:text-zinc-100 border-transparent"
                  }`}
                >
                  <span className={`transition-colors duration-200 ${isActive ? "text-amber-500" : "text-zinc-500 group-hover:text-zinc-300"}`}>
                    {item.icon}
                  </span>
